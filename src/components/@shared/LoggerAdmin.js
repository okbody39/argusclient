...
class Footer extends Component {
  constructor(props) {
    ...
    this.state = {
      logs: JSON.parse(localStorage.getItem("ARGUS.ADMIN.LOGS")) || [],
    };
  }

  componentDidMount() {

    window.ipcRenderer.on("admin-log", (event, arg) => {
      ...
      localStorage.setItem("ARGUS.ADMIN.LOGS",  JSON.stringify(logs));
  ...
  componentWillUnmount() {
    window.ipcRenderer.removeAllListeners('admin-log');
  }
